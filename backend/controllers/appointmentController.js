...
const sendAppointmentNotification = (req, res) => {
    ...
    if (!patientName || !patientEmail || !ownerEmail || !typeOfService || !appointmentDate || !appointmentTime) {
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                  <td style="padding: 10px; border: 1px solid #e0e0e0; background-color: #f9f9f9;">Appointment Date:</td>
                  <td style="padding: 10px; border: 1px solid #e0e0e0;">${appointmentDate}</td>
                </tr>
                <tr>
                  <td style="padding: 10px; border: 1px solid #e0e0e0; background-color: #f9f9f9;">Appointment Time:</td>
                  <td style="padding: 10px; border: 1px solid #e0e0e0;">${appointmentTime}</td>
                </tr>
              </table>
